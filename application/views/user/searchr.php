...
<div style="border:1px solid #DE4949;padding-left:10px;border-radius:5px;margin-bottom:10px">
...
}else{ ?> <h3 style="margin-left:60px;">Data not found, Please try with different phrases.</h3> <?php } ?>
